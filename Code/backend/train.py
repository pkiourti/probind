...
def get_parser():
    ...
    parser.add_argument('--path', type=str, default='data',
                        ...
                        dest='path')
    parser.add_argument('--name_x_forward', type=str, default='x_forward_5.npy',
                        help='name of npy file that contains the forward sequences',
                        dest='name_x_forward')
    parser.add_argument('--name_x_reverse', type=str, default='x_reverse_5.npy',
                        help='name of npy file that contains the reverse sequences',
                        dest='name_x_reverse')
    parser.add_argument('--name_y', type=str, default='y_5.npy',
...
if __name__ == '__main__':
    ...
    for epoch in range(epochs):
        for b, (X_train_forward, X_train_reverse, y_train) in enumerate(train_loader):
            ...
            writer.add_graph(model, (X_train_forward, X_train_reverse))
            writer.close()
            break
    ...
    torch.save(model.state_dict(), os.path.join('models', 'model_1'))
