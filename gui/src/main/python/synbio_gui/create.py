import numpy as np
import os
from gui.src.main.python.synbio_gui.generator import DNASeqGenerator
...
if __name__ == '__main__':
    ...
    forward_file, reverse_file, bind_v_file = data_files('gui/src/main/python/synbio_gui/data')
